...
@XmlRootElement(name="PageBeanDocument")
public class PageBeanDocument{
    //已知数据
	...
	//该筛选条件下总的list集合中
    private List<Document> totalList;
    //将每页要显示的数据放在list集合中
    private List<Document> perList;
    ...
    //构造方法中将pageNum，pageSize，totalRecord获得
     ...
     public PageBeanDocument(List<Document> list,int pageNum) {
        ...
        * 得到返回页面的list
        */
       List<Document> listTemp = new ArrayList<Document>();
    ...
    @XmlElement
    public List<Document> getTotalList() {
		return totalList;
	}

	public void setTotalList(List<Document> totalList) {
		this.totalList = totalList;
	}
	@XmlElement
	public List<Document> getPerList() {
		return perList;
	}

	public void setPerList(List<Document> perList) {
